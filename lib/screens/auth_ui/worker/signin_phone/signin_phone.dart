...
import 'package:karibu_kazi/screens/auth_ui/worker/password_worker/create_password.dart';

class SignInPhone1 extends StatefulWidget {
  const SignInPhone1({super.key});

  @override
  State<SignInPhone1> createState() => _SignInPhone1State();
}

class _SignInPhone1State extends State<SignInPhone1> {

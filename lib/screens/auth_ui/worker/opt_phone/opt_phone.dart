...
import 'package:karibu_kazi/screens/auth_ui/worker/create_password/create_password.dart';

class OPTPhone1 extends StatefulWidget {
  const OPTPhone1({super.key});

  @override
  State<OPTPhone1> createState() => _OPTPhone1State();
}

class _OPTPhone1State extends State<OPTPhone1> {
                  ...
                  child: CustomButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const CreatePassword1(),
                        ),
                      );
                    },
                  ),

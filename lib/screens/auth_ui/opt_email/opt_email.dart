...
class OPTEmail extends StatefulWidget {
  const OPTEmail({super.key});

  @override
  State<OPTEmail> createState() => _OPTEmailState();
}

class _OPTEmailState extends State<OPTEmail> {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  "A verification code was send to peternjenga@glitex.co.ke.\nEnter the code and verify your email.",
                  style: TextStyle(
                    color: Colors.black,
                  ),
                ),

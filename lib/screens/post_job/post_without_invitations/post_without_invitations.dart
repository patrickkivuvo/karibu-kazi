...
class PostWithoutInvitation extends StatefulWidget {
  const PostWithoutInvitation({super.key});

  @override
  State<PostWithoutInvitation> createState() => _PostWithoutInvitationState();
}

class _PostWithoutInvitationState extends State<PostWithoutInvitation> {
  @override
            ...
            child: Center(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    "Check out bids to award a worker",
                    style: TextStyle(
                      fontWeight: FontWeight.w400,
                      fontSize: 14,
                      color: TColor.secondaryText,
